package   com.libs.loaders
{
	...
	public class MultipartURLLoader extends EventDispatcher
	{
		...
		/**                   * Add string variable to loader                   * If you have already added variable with the same name it will be overwritten                   *                   * @param       name    Variable name                   * @param       value   Variable value                   */
		...
		/**                   * Add file part to loader                   * If you have already added file with the same fileName it will be overwritten                   *                   * @param       fileContent     File content encoded to ByteArray                   * @param       fileName        Name of the file                   * @param       dataField       Name of the field containg file data                   * @param       contentType     MIME type of the uploading file                   */
		...
		public function dispose():void
		{
			...
			requestHeaders = null;
			_data = null;
		}/**                   * Generate random boundary                   * @return      Random boundary                   */
